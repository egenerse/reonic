...
-- AddForeignKey
ALTER TABLE "public"."SimulationOutput" ADD CONSTRAINT "SimulationOutput_inputId_fkey" FOREIGN KEY ("inputId") REFERENCES "public"."SimulationResult"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
